...
/**
 * Allows the user to draw a blimp cart
 * 
 * @author Jhhacker 
 * @version 10.10.15
 */
public class BlimpCart
{
    // puts the cart on the grid horizontally
    private int xvar;
    // puts the cart on the grid vertically
    private int yvar;
    // defines the height
    private int height;
    // defines the width
     ...
     */
    public BlimpCart(int xvar, int yvar, int height, int width)
    {
        this.xvar = xvar;
        this.yvar = yvar;
        this.height = height;
