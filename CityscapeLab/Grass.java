...
public class Grass
{
    // puts the grass on the grid horizontally
    private int xvar;
    // puts the grass on the grid vertically
    private int yvar;
    // defines the height
    private int height;
    // defines the width
     ...
     */
    public Grass(int xvar, int yvar, int height, int width)
    {
        this.xvar = xvar;
        this.yvar = yvar;
        this.height = height;
